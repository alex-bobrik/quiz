 ...
 */
final class Version20200223203254 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318CA0F35D66 FOREIGN KEY (current_question_id) REFERENCES question (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
