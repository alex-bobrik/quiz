 ...
 */
final class Version20200215132536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game ADD current_question_id INT DEFAULT NULL, ADD game_is_over TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE game DROP current_question_id, DROP game_is_over');
    }
}
